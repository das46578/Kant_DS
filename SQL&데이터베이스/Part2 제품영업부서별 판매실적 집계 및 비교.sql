...
SELECT
    ...
    ROUND(AVG(s.sale_amount), 2) AS avg_sales_amount
FROM public.sales s
INNER JOIN public.sales_departments sd
...
1. 총 판매 금액이 가장 높은 제품은 리피다운정 20mg이고 부서는 호남영업팀이다.
2. 제품은 리피다운정 20mg 17,145,700원과 코프릴시럽 498,569원으로 16,647,131원 차이가 나고,
   부서는 호남영업팁 34,490,967원과 강원영업팁 9,895,165원 차이가 난다.
3-1. 리피다운정 20mg은 거래 9건과 평균 판매 금액 1,905,077.78원, 코프릴시럽은 거래 2건과 평균 판매 금액 249,284.5원으로
	 평균 판매 금액이 높은 것이 실적 차이에 영향을 준 것으로 보인다.
3-2. 호남영업팀은 거래 26건과 평균 판매금 액 1,326,575.65원, 강원영업팀은 거래 16건과 618,447.81원으로
	 거래 건수와 평균 판매 금액이 높아 실적 차이가 발생한 것으로 보인다.
